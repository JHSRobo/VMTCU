...
(cl:defmethod cl:initialize-instance :after ((m <controlData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'controlData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rov_control-msg:<controlData> is deprecated: use rov_control-msg:controlData instead.")))

(cl:ensure-generic-function 'thrusterStatus-val :lambda-list '(m))
(cl:defmethod thrusterStatus-val ((m <controlData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control-msg:thrusterStatus-val is deprecated.  Use rov_control-msg:thrusterStatus instead.")
  (thrusterStatus m))

(cl:ensure-generic-function 'dhStatus-val :lambda-list '(m))
(cl:defmethod dhStatus-val ((m <controlData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control-msg:dhStatus-val is deprecated.  Use rov_control-msg:dhStatus instead.")
  (dhStatus m))

(cl:ensure-generic-function 'targetDepth-val :lambda-list '(m))
(cl:defmethod targetDepth-val ((m <controlData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control-msg:targetDepth-val is deprecated.  Use rov_control-msg:targetDepth instead.")
  (targetDepth m))

(cl:ensure-generic-function 'linearSense-val :lambda-list '(m))
(cl:defmethod linearSense-val ((m <controlData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control-msg:linearSense-val is deprecated.  Use rov_control-msg:linearSense instead.")
  (linearSense m))

(cl:ensure-generic-function 'angularSense-val :lambda-list '(m))
(cl:defmethod angularSense-val ((m <controlData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control-msg:angularSense-val is deprecated.  Use rov_control-msg:angularSense instead.")
  (angularSense m))

(cl:ensure-generic-function 'verticalSense-val :lambda-list '(m))
(cl:defmethod verticalSense-val ((m <controlData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control-msg:verticalSense-val is deprecated.  Use rov_control-msg:verticalSense instead.")
  (verticalSense m))

(cl:ensure-generic-function 'camera-val :lambda-list '(m))
(cl:defmethod camera-val ((m <controlData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control-msg:camera-val is deprecated.  Use rov_control-msg:camera instead.")
  (camera m))
