...
(cl:defmethod cl:initialize-instance :after ((m <StringArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name keyboard_teleop-msg:<StringArray> is deprecated: use keyboard_teleop-msg:StringArray instead.")))

(cl:ensure-generic-function 'strings-val :lambda-list '(m))
(cl:defmethod strings-val ((m <StringArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader keyboard_teleop-msg:strings-val is deprecated.  Use keyboard_teleop-msg:strings instead.")
  (strings m))
