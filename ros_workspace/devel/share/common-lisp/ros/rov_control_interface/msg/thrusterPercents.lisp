...
(cl:defmethod cl:initialize-instance :after ((m <thrusterPercents>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'thrusterPercents)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rov_control_interface-msg:<thrusterPercents> is deprecated: use rov_control_interface-msg:thrusterPercents instead.")))

(cl:ensure-generic-function 't1-val :lambda-list '(m))
(cl:defmethod t1-val ((m <thrusterPercents>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control_interface-msg:t1-val is deprecated.  Use rov_control_interface-msg:t1 instead.")
  (t1 m))

(cl:ensure-generic-function 't2-val :lambda-list '(m))
(cl:defmethod t2-val ((m <thrusterPercents>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control_interface-msg:t2-val is deprecated.  Use rov_control_interface-msg:t2 instead.")
  (t2 m))

(cl:ensure-generic-function 't3-val :lambda-list '(m))
(cl:defmethod t3-val ((m <thrusterPercents>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control_interface-msg:t3-val is deprecated.  Use rov_control_interface-msg:t3 instead.")
  (t3 m))

(cl:ensure-generic-function 't4-val :lambda-list '(m))
(cl:defmethod t4-val ((m <thrusterPercents>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control_interface-msg:t4-val is deprecated.  Use rov_control_interface-msg:t4 instead.")
  (t4 m))

(cl:ensure-generic-function 't5-val :lambda-list '(m))
(cl:defmethod t5-val ((m <thrusterPercents>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control_interface-msg:t5-val is deprecated.  Use rov_control_interface-msg:t5 instead.")
  (t5 m))

(cl:ensure-generic-function 't6-val :lambda-list '(m))
(cl:defmethod t6-val ((m <thrusterPercents>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_control_interface-msg:t6-val is deprecated.  Use rov_control_interface-msg:t6 instead.")
  (t6 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<thrusterPercents>)))
  ...
  "rov_control_interface/thrusterPercents")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'thrusterPercents)))
  "Returns string type for a message object of type 'thrusterPercents"
  "rov_control_interface/thrusterPercents")
