...
from rov_control_interface.msg import controlData
...
class CameraSwitcher:
    ...
    def __init__(self):
        ...
        self.camera_sub = rospy.Subscriber('rov/control', controlData, self.change_camera_callback)
    ...
    def change_camera_callback(self, control):
        ...
        elif self.num != control.camera:
            if self.ip:
                self.change = True
                self.num = control.camera
