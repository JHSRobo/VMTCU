...
set(MSG_I_FLAGS "-Itcu_board_msgs:/home/jhsrobo/Github/ROVMIND/ros_workspace/src/tcu_board_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jhsrobo/Github/ROVMIND/ros_workspace/src/tcu_board_msgs/msg/tcu_board_data.msg" NAME_WE)
add_custom_target(_tcu_board_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tcu_board_msgs" "/home/jhsrobo/Github/ROVMIND/ros_workspace/src/tcu_board_msgs/msg/tcu_board_data.msg" ""
)
...
_generate_msg_cpp(tcu_board_msgs
  "/home/jhsrobo/Github/ROVMIND/ros_workspace/src/tcu_board_msgs/msg/tcu_board_data.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tcu_board_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tcu_board_msgs\")")
  # install generated code
  install(
